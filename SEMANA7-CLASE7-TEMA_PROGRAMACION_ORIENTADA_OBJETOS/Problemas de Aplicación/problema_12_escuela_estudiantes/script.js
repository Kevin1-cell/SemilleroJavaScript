...
const estu1 = new Estudiante("Sandro", 15);
const estu2 = new Estudiante("Sandra", 12);
const estu3 = new Estudiante("Juanchito", 17);
...
console.log(
  `Hay ${Escuela.getCantEstudiantes()} estudiantes registrados en la escuela`
);
